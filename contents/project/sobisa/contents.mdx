...
- 23/4 ~ 23/5간 진행한 디자이너 1명, 프론트엔드 개발자 2명이서 진행한 팀 프로젝트의 팀장과 프론트엔드 개발자로 참여.
...
<div className='grid items-start grid-cols-[40%_auto] [&_img]:max-h-max print:[&_img]:max-h-[10cm] gap-3 [&_*]:mt-0'>
...
<div className='grid items-start grid-cols-[40%_auto] [&_img]:max-h-max print:[&_img]:max-h-[10cm] gap-3'>
